...
- **How you get paid back**: each person sets their own preferred method (Venmo, Zelle, PayPal, Cash, or Other) plus a username, phone, or email. It's shown inline to whoever owes them — right on the "you owe X" row — so nobody has to ask around for handles. Trip settings lists everyone's, so it's easy to see who hasn't filled theirs in.
